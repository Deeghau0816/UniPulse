...
import { ticketNotificationService, type TicketNotificationItem, type TicketNotificationType, type TicketFilterType } from '../services/ticketNotificationService';
...
const TicketNotificationsPage = () => {
  ...
  const getNotificationClass = (type: TicketNotificationType): string => {
    switch (type) {
      case 'STATUS_CHANGE':
        return 'notif-status';
      case 'NEW_COMMENT':
  ...
  const getNotificationLabel = (type: TicketNotificationType): string => {
    switch (type) {
      case 'STATUS_CHANGE':
